    ...
    <div className="max-w-4xl mx-auto flex leading-relaxed bg-white text-gray-900 font-sans shadow-lg">
      <aside className="w-1/3 shrink-0 p-8 text-white flex flex-col gap-8" style={{ backgroundColor: accentColor }}>
        ...
        {data.socials?.length > 0 && (
          <section>
            <h2 className="text-sm uppercase tracking-wider font-bold mb-3 opacity-80">Socials</h2>
            <div className="space-y-2 text-sm opacity-90">
        ...
        {data.languages?.length > 0 && (
          <section>
            <h2 className="text-sm uppercase tracking-wider font-bold mb-3">LANGUAGES</h2>
      ...
      <main className="w-2/3 min-w-0 p-8 flex flex-col gap-6">
        ...
        {hasContent(data.certifications) && (
          <section>
            <h2 className="text-xl font-semibold mb-4" style={{ color: accentColor }}>CERTIFICATIONS</h2>
            <div
              className="text-gray-700 text-sm ql-editor !p-0"
