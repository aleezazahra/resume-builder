  ...
  const handlePhotoUpload = (e) => {
    ...
    reader.onload = (ev) => {
      if (data.personal_info) {
        data.personal_info.photo = ev.target.result;
      }
    };
      ...
      <aside className="w-1/3 shrink-0 p-8 text-white flex flex-col gap-8" style={{ backgroundColor: accentColor }}>
           ...
           <div className="col-span-1  py-10">
                    ...
                    {data.personal_info?.image && typeof data.personal_info.image === 'string' ? (
                        <div className="mb-2">
                            <img src={data.personal_info.image} alt="Profile" className="w-36 h-36 object-cover rounded-full mx-auto" style={{ background: accentColor+'70' }} />
                        </div>
                    ) : (
                        data.personal_info?.image && typeof data.personal_info.image === 'object' ? (
                            <div className="mb-2">
                                <img src={URL.createObjectURL(data.personal_info.image)} alt="Profile" className="w-38 h-38 object-cover rounded-full mx-auto" />
                            </div>
                        ) : null
                    )}
                </div>
