...
const Login=()=>{
    ...
    const handleChange = (e) => {
        ...
        setFormData(prev => ({ ...prev, [name_]: value }))
    }
   
         

    return (
            <form onSubmit={handleSubmit} className="sm:w-[350px] ml-140 mt-40 w-full text-center border border-gray-300/60 rounded-2xl px-8 bg-white">
                ...
                {state !== "login" && (
                    <div className="flex items-center mt-6 w-full bg-white border border-gray-300/80 h-12 rounded-full overflow-hidden pl-6 gap-2">
                        ...
                        <input type="text" name="name" placeholder="Name" className="border-none outline-none ring-0" value={formData.name_} onChange={handleChange} required />
                    </div>
                )}
