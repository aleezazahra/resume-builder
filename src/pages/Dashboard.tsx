import { FilePenIcon, PencilIcon, PlusIcon, TrashIcon, UploadIcon, XIcon } from "lucide-react";
    ...
    return (
        <div>
            <div className="max-w-7xl mx-auto px-4 py-8">
                    ...
                    {allResumes.map((resume, index) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="absolute top-1 right-1 hidden group-hover:flex items-center bg-white/80 rounded shadow-sm backdrop-blur-xs">
                                    <TrashIcon className="size-7 p-1.5 hover:bg-red-50 hover:text-red-600 rounded text-slate-700 transition-colors" />
                                    <PencilIcon className="size-7 p-1.5 hover:bg-slate-100 rounded text-slate-700 transition-colors" />
                                </div>
                            </button>
                        );
                    })}
                ...
                {
                    showCreateResume && (
                        <form onSubmit={createResume} onClick={()=> setShowCreateResume} className='fixed insert-0 bg-black/70 backdrop-blur bg-opacity-50 z-10 items-center justify-center' action="">
