        ...
        <div className="space-y-6">
            ...
            { data.length === 0 ?(
                    <div className="text-center py-8 text-gray-500">
                        ...
                        <p>Add experience to get started</p>
                    </div>
                ):(
                    <div className="space-y-4">
                        ...
                        <div key={index} className="p-4 border border-gray-200 rounded-lg space-y-3">
                            ...
                            <div className="grid md:grid-cols-2 gap-3">
                                ...
                                className="
                                px-3 py-2 text-sm rounded-lg disable:bg-gray-100" />
    ...
    <span className="text-sm text-gray-700">Currently working here</span>
                            ...
                            <div className="space-y-2">
                                <div className="flex items-center justify-between">
                                    ...
                                    <button className="flex items-center gap-1 px-2 py-1 text-xs bg-purple-200
                                ...
                                <textarea value={experience.description || ""} onChange={(e)=>updateExperience(index,"description",e.target.value)} rows={4}
                                 className="w-full tet-sm px-3 py-2
                                rounded-lg resize-none" placeholder="Describe your resposibilites and achievements" />
                        </div>
