        ...
        <div>
            ...
            <div className="flex items0-center gap-2">
                <label htmlFor="">
                    ...
                    <input type="file" accept="image/jpeg, image/png" hidden onChange={(e)=>handleChange("image",e.target.files[0])}></input>
                </label>
                {
                    typeof data.image ==='object' &&(
                        <div className="flex flex-col gap-1 pl-4 text-sm">
                            ...
                            <label className="relative inline-flex items-center cursor-pointer text-gray-900 gap-3">
                                <input type="checkbox" className="sr-only peer" onChange={(e)=>setRemoveBackground(prev=>!prev)} checked={removeBackground} ></input>
